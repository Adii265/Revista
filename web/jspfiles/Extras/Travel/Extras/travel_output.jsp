    ...
    <div class ="container">
        <div class="table" style="text-align:center">
				<table class="table-bordered">
					<tr>
						<th width = "25%" style =" text-align:center; text-style:bold">DATE</th>
                                                <th width = "25%" style ="text-align:center; text-style:bold">TITLE</th>
						<th width = "65%" style ="text-align:center; text-style:bold">Travel memories</th>
                                                <th width = "25%" style ="text-align:center; text-style:bold">FILE</th>
						<td width = "10%">&nbsp</td>
                                                <td width ="10%">&nbsp</td>
					</tr>
					<%    
						...
						try{
								Class.forName("com.mysql.jdbc.Driver");	
								con = DriverManager.getConnection("jdbc:mysql://localhost:3306/project3year","root","");
								st=con.createStatement();
								rs=st.executeQuery("select * from travel where Serial like "+serial);
								int i=1;
								while(rs.next())
								{	
									sno=rs.getInt(5);
								%>	     
									<tr>
										...
										<td><a href="..\Travel\travel_update.jsp?Serial=<%=serial%>"><span class="glyphicon glyphicon-pencil" >&nbsp</span></a></td>
                                                                                <td><a href="../Travel/travel_delete.jsp?Serial=<%=serial%>"><span class="glyphicon glyphicon-remove-sign" >&nbsp</span></a></td>
									</tr>
									<%          
										i=i+1;
								}
