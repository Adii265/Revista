                ...
                <div>
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav navbar-right">
                            <li style = "margin-top:2%;font-size:120%"><a href="../USER_Profile/Activities/user_update.jsp">Update older records</a></li>
                            <li style = "margin-top:2%;font-size:120%"><a href="../USER_Profile/Activities/user_del.jsp">Delete records</a></li>
                            <li style = "margin-top:2%;font-size:120%"><a href="../USER_Profile/Activities/user_pass_reset.jsp">Password change</a></li>
                            <li >
                                <div class="dropdown" >
                                    <br>
                                    ...
                                    try
                                    {
                                        ...
                                        while(rs.next())
                                        {
                                            ...
                                            out.println("<li><a href='../USER_Profile/Activities/user_profile.jsp'>Profile</a></li>");
                                            out.println("<ul>");
